  ...
  const handleVerify = async (code: string) => {
    ...
    try {
      ...
      if (password) {
        ...
        Alert.alert("Success", "Email verified. Please log in with your password.");
        navigation.navigate('Login', { initialForm: 'email' });
      }
    } catch (err: any) {
      setVerifying(false);
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <Text style={styles.successTitle}>
              ...
              <Text style={styles.sansText}>Home</Text>
            </Text>
        ...
        >
          ...
          <View style={styles.header}>
            <Text style={styles.titleEditorial}>
              ...
              <Text style={styles.sansText}>Your Email</Text>
            </Text>
          ...
          {verifying && (
            <View style={styles.verifyingRow}>
              <Text style={styles.verifyingText}>
                Authenticating your college identity...
              </Text>
            </View>
          )}
          ...
          <View style={styles.helpSection}>
            ...
            >
              <Text style={styles.smsText}>
                No email access? <Text style={styles.coralText}>Use SMS verification →</Text>
              </Text>
            </TouchableOpacity>
          </View>
          </Animated.View>
...
const styles = StyleSheet.create({
  ...
  otpInput: {
    ...
    fontWeight: '700',
    color: '#FFF',
    padding: 0, // Critical for centering
    ...Platform.select({
      android: {
